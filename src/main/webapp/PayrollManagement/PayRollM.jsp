		...
		<nav
			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					...
					<h6 class="font-weight-bolder mb-0 text-white" id="BreadChng">Employee Payroll</h6>
				</nav>
				<div
					...
					<div class="row mb-4">
						<div class="col-md-8 mt-md-0 mt-4">
							<div class="card z-index-2">
								<div class="card-header p-3 pb-0">
									<h6>Bar chart Employee</h6>
								</div>
								<div class="card-body p-3">
									<div class="chart">
										<canvas id="bar-chart" class="chart-canvas" style="height:330px;"></canvas>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-12 col-md-4 d-flex justify-content-start">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								...
								<li class="nav-item" onclick="brd5_3();"><a
									class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
									href="#emp-Overtime" role="tab" aria-controls="pills-Overtime"
									aria-selected="false">Overtime</a></li>
							</ul>
						</div>
					</div>
						...
						<div class="col-12 mt-md-0 mt-0">
							<div class="card">
								<div class="tab-content">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	...
																	<button type="button"
																		...
																		data-bs-target="#Allowanceimport">Import</button>
																	...
																	<div class="modal fade" id="Allowanceimport"
															...
															<table class="table" id="datatable-search5">
																...
																<tbody>
																	<tr>
																		...
																		</a> <a href="javascript:;" class="mx-3"
																			data-bs-toggle="modal"
													...
													<div class="modal-body p-0">
														<div class="row">
															...
															<div class="col-lg-8 mt-lg-0 mt-4">
																<div class="card">
																	<div class="card-body">
																		<h5 class="font-weight-bolder">Product
																			Information</h5>
																		<div class="row">
																		...
																		<div class="row">
																			<div class="col-sm-6">
																				...
																				<div id="edit-deschiption-edit" class="h-50">
																					Long sleeves black denim jacket with a twisted
																					design. Contrast stitching. Button up closure.
																					White arrow prints on the back.</div>
																			</div>
																			<div class="col-sm-6">
															...
															<div class="col-sm-4">
																<div class="card">
																	<div class="card-body">
																		...
																		<label>Shoppify Handle</label> <input
																			class="form-control" type="text" value="@argon" /> <label
																			class="mt-4">Facebook Account</label> <input
																			class="form-control" type="text" value="https://" />
																		<label class="mt-4">Instagram Account</label> <input
																			class="form-control" type="text" value="https://" />
																	</div>
																</div>
															</div>
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	...
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#Deductionsimport">Import</button>
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="Deductionsimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
									...
									<div class="tab-pane fade" id="emp-Overtime" role="tabpanel">
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
													<div class="card-header pb-0">
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#empAddOvertime">+&nbsp; New
																		Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#empOvertimeimport">Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="empAddOvertime"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="empOvertimeimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel7('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
																...
																<tbody>
																	<tr>
																		...
																		<td class="text-sm"><a href="javascript:;"
																			...
																			data-bs-toggle="modal"
																			data-bs-target="#empOvertimeEditModal"> <i
																				class="fas fa-user-edit text-secondary"></i>
																		</a> <a href="javascript:;" data-bs-toggle="tooltip"
																			data-bs-original-title="Delete product"> <i
																				class="fas fa-trash text-secondary"></i>
										...
										<!-- edit modal strarts here -->
										<div class="modal fade" id="empOvertimeEditModal"
					...
					<div class="row">
						<div class="col-12 col-md-4 d-flex justify-content-start">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								...
								<li class="nav-item" onclick="brd6_3();"><a
									class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
									href="#staff-Overtime" role="tab"
									aria-controls="pills-Overtime" aria-selected="false">Overtime</a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="col-12 mt-md-0 mt-0">
							<div class="card">
								<div class="tab-content">
														...
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StaffAllowance">+&nbsp; New
																		Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StaffAllowanceimport">
																		Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="StaffAllowance"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel8('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
									...
									<div class="tab-pane fade" id="staff-Deductions"
										role="tabpanel">
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
														...
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StaffDeductions">+&nbsp; New
																		Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StuffDeductionsimport">
																		Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="StaffDeductions"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="StuffDeductionsimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel9('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
																...
																<tbody>
																	<tr>
																		...
																		<td class="text-sm"><a href="javascript:;"
																			...
																			data-bs-toggle="modal"
																			data-bs-target="#StaffDeductionsEditModal"> <i
																				class="fas fa-user-edit text-secondary"></i>
																		</a> <a href="javascript:;" data-bs-toggle="tooltip"
																			data-bs-original-title="Delete product"> <i
																				class="fas fa-trash text-secondary"></i>
										...
										<!-- edit modal strarts here -->
										<div class="modal fade" id="StaffDeductionsEditModal"
											tabindex="-1" role="dialog"
											aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-xl" role="document">
												<div class="modal-content">
									...
									<div class="tab-pane fade" id="staff-Overtime" role="tabpanel">
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
													<div class="card-header pb-0">
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StaffAddOvertime">+&nbsp; Add
																		Overtime</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#StaffOvertimeimport">Import
																	</button>

																	<!-- modal of add overtime starts -->
																	<div class="modal fade" id="StaffAddOvertime"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="StaffOvertimeimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel10('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
																...
																<tbody>
																	<tr>
																		...
																		<td class="text-sm"><a href="javascript:;"
																			...
																			data-bs-toggle="modal"
																			data-bs-target="#StaffOvertimeEditModal"> <i
																				class="fas fa-user-edit text-secondary"></i>
																		</a> <a href="javascript:;" data-bs-toggle="tooltip"
																			data-bs-original-title="Delete product"> <i
																				class="fas fa-trash text-secondary"></i>
										...
										<!-- edit modal strarts here -->
										<div class="modal fade" id="StaffOvertimeEditModal"
											tabindex="-1" role="dialog"
											aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-xl" role="document">
												<div class="modal-content">
					...
					<div class="row">
						<div class="col-12 col-md-4 d-flex justify-content-start">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								...
								<li class="nav-item" onclick="brd7_3();"><a
									class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
									href="#delievery-Overtime" role="tab"
									aria-controls="pills-Overtime" aria-selected="false">Overtime</a>
								</li>
							</ul>
						</div>
						...
						<div class="col-12 mt-md-0 mt-0">
							<div class="card">
								<div class="tab-content">
										...
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
														...
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#deliveryAllowance">+&nbsp; New
																		Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#deliveryAllowanceimport">
																		Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="deliveryAllowance"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="deliveryAllowanceimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel11('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
													...
													<div class="card-body px-0 pb-0">
														<div class="table-responsive"
															id="tbl_exporttable_to_xls_11">
															<table class="table" id="datatable-search11">
																<thead class="thead-light">
																	<tr>
																		<th>Product</th>
																		<th>Category</th>
									...
									<div class="tab-pane fade" id="delievery-Deductions"
										role="tabpanel">
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
														...
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#AdddeliveryDeductions">+&nbsp;
																		New Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#deliveryDeductionsimport">
																		Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="AdddeliveryDeductions"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="deliveryDeductionsimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel12('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
													...
													<div class="card-body px-0 pb-0">
														<div class="table-responsive"
															id="tbl_exporttable_to_xls_12">
															<table class="table" id="datatable-search12">
																<thead class="thead-light">
																	<tr>
																		<th>Product</th>
																		<th>Category</th>
																...
																<tbody>
																	<tr>
																		...
																		<td class="text-sm"><a href="javascript:;"
																			...
																			data-bs-toggle="modal"
																			data-bs-target="#deliveryDeductionsEditModal"> <i
																				class="fas fa-user-edit text-secondary"></i>
																		</a> <a href="javascript:;" data-bs-toggle="tooltip"
																			data-bs-original-title="Delete product"> <i
																				class="fas fa-trash text-secondary"></i>
										...
										<!-- edit modal strarts here -->
										<div class="modal fade" id="deliveryDeductionsEditModal"
											tabindex="-1" role="dialog"
											aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-xl" role="document">
												<div class="modal-content">
									...
									<div class="tab-pane fade" id="delievery-Overtime"
										role="tabpanel">
										<div class="row mt-0">
											<div class="col-12">
												<div class="card">
														...
														<div class="d-lg-flex">
															...
															<div class="ms-auto my-auto mt-lg-0 mt-4">
																<div class="ms-auto my-auto">
																	<a href="#" class="btn bg-gradient-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#deleiveryAddOvertime">+&nbsp; New
																		Product</a>
																	<button type="button"
																		class="btn btn-outline-primary btn-sm mb-0"
																		data-bs-toggle="modal"
																		data-bs-target="#deleieveryOvertimeimport">
																		Import</button>

																	<!-- modal of add inventory starts -->
																	<div class="modal fade" id="deleiveryAddOvertime"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog modal-lg mt-lg-10">
																			<div class="modal-content">
																	...
																	<!-- modal of import starts here -->
																	<div class="modal fade" id="deleieveryOvertimeimport"
																		tabindex="-1" aria-hidden="true">
																		<div class="modal-dialog mt-lg-10">
																			<div class="modal-content">
																				<div class="modal-header">
																	...
																	<button
																		class="btn btn-outline-primary btn-sm export mb-0 mt-sm-0 mt-1"
																		onclick="ExportToExcel13('xlsx')" type="button"
																		name="button">Export</button>
																</div>
															</div>
														</div>
													...
													<div class="card-body px-0 pb-0">
														<div class="table-responsive"
															id="tbl_exporttable_to_xls_13">
															<table class="table" id="datatable-search13">
																<thead class="thead-light">
																	<tr>
																		<th>Product</th>
																		<th>Category</th>
