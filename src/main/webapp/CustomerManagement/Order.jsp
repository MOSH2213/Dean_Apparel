														...
														<div class="table-responsive ">
															<table class="table text-right"
																...
																<thead class="bg-default">
																	<tr>
																		<th scope="col"
																			class="pe-2 text-start ps-2 text-white">Item</th>
										...
										<div class="col-6">
											<div class="form-group">
												...
												<input required class="form-control"
													value="<%=authin != null ? authin.getFname() : ""%>" type="text"
													placeholder="john" id="feedbackfname">
											</div>
										</div>
										<div class="col-6">
											<div class="form-group">
												...
												<input required class="form-control"
													value="<%=authin != null ? authin.getLname() : ""%>" type="text"
													placeholder="smith" id="feedbacklname">
											</div>
										</div>
									</div>
